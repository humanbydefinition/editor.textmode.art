            ...
            >
                <ScrollArea className="h-full">
                    <div className="p-4 space-y-4 text-sm text-zinc-400 leading-relaxed">
                        ...
                        <div>
                            <h4 className="font-medium text-zinc-200 mb-2 text-xs uppercase tracking-wider">Provider Information (Section 5 DDG)</h4>
                        ...
                        <div>
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-zinc-500 text-[11px] leading-relaxed italic">
                                    Alternative: Use the contact form button at the bottom of this tab.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            <h4 className="font-medium text-zinc-200 mb-2 text-xs uppercase tracking-wider">Liability for Own and External Content</h4>
            ...
            >
                <ScrollArea className="h-full">
                    <div className="p-4 space-y-4 text-sm text-zinc-400 leading-relaxed">
                        ...
                        <div>
                            <h4 className="font-medium text-zinc-200 mb-2 text-xs uppercase tracking-wider">Unreviewed Sketches and Execution Risk</h4>
                            <p className="text-zinc-500 break-words">
            ...
            >
                <ScrollArea className="h-full">
                    <div className="p-4 space-y-4 text-sm text-zinc-400 leading-relaxed">
                        ...
                        <div>
                            <h4 className="font-medium text-zinc-200 mb-2 text-xs uppercase tracking-wider">Publish Requests and Gallery Moderation</h4>
                            <p className="text-zinc-500 break-words">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 break-words">
                                If you use the integrated contact form, we process the data you provide (name, email address,
                                subject, and message) to process and answer your request.
                            </p>
                            <p className="text-zinc-500 mt-2 break-words">
                                Purpose: handling your contact request.
                                <br />
                                Legal basis: Art. 6(1)(b) GDPR (contractual or pre-contractual requests) or Art. 6(1)(f) GDPR
                                (legitimate interests in effective communication).
                            </p>
                            <p className="text-zinc-500 mt-2 break-words">
                                Storage: The data is sent to us by email and stored for the duration of the communication and any
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 mt-2 break-words">
                                ...
                                verification is used only for security/abuse prevention in publish and contact requests.
                            </p>
                            <p className="text-zinc-500 mt-2 break-words">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-500 break-words">
                                When you submit content to the gallery or when a submission is approved, certain data is
                                transmitted to Discord via a bot API to notify our moderation team and community.
                            </p>
                            <p className="text-zinc-500 mt-2 break-words">
                            ...
                            <p className="text-zinc-500 mt-2 break-words">
                                Recipient: Discord, Inc. (USA). Discord participates in the EU-U.S. Data Privacy Framework (DPF),
                                providing an adequacy decision for data transfers to the USA.
                            </p>
                            <ul className="list-disc list-inside mt-2 text-zinc-500 space-y-1">
                                <li>
                                    <a
                        ...
                        <div>
                            <h4 className="font-medium text-zinc-200 mb-2 text-xs uppercase tracking-wider">External Resources and Third-Party Endpoints</h4>
                            <p className="text-zinc-500 break-words">
