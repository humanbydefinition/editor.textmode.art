    ...
    return (
        <aside className="hidden lg:block lg:w-[320px] lg:flex-none">
            <div className="sticky top-20 space-y-4 px-4 pb-8">
                <Card className="border-2 border-border bg-card shadow-none">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <Button variant="outline" className="h-10 w-full border-2 border-border" onClick={onSignOut}>
                            Sign out
                        </Button>
                    </CardContent>
                </Card>
                ...
                <Card className="border-2 border-border bg-card shadow-none">
                    ...
                    <CardContent className="space-y-3">
                        <div className="flex items-center gap-3 rounded-lg border-2 border-border bg-background px-3 py-2.5">
