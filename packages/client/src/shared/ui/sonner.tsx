    ...
    return (
        <Sonner
            ...
            toastOptions={{
                classNames: {
                    toast:
                        'group toast pointer-events-auto group-[.toaster]:border-2 group-[.toaster]:border-border group-[.toaster]:bg-card group-[.toaster]:text-card-foreground group-[.toaster]:shadow-none',
